...
\titlegraphic{
	\begin{picture}(0,0)
		\put(350,-75){\makebox(0,0)[rt]
			{\includegraphics[width=250pt]{../figures/iitd_logo.pdf}}}
	\end{picture}
}


%\titlegraphic{\vspace{75pt} \includegraphics[width=250pt]{../figures/iitd_logo.pdf}}
\title{A Synopsis of the work done in my Master of Science in Electrical Engineering (Power Systems) degree}
