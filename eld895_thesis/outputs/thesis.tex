...
\program{Masters of Science in Electrical Engineering}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Title page
\newcommand{\title}[0]{Data Analysis for Predicting Instabilities in Power Systems}
...
\noindent This is to certify that the thesis titled {\bf CLASS
