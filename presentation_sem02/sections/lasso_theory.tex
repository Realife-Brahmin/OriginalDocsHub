...
\label{sec:lasso_theory}
	...
	\textit{Assumption 1:}
	Both $\boldsymbol{u}(t)$ and $\boldsymbol{a_r}(t)$ are sparse vectors. That implies most locations are FO free and for the the locations that do have FO, the number of distinct sinusoidal components is small.
	\end{frame}