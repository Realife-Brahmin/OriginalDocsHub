...
\label{sec:lasso_theory}
	...
	\begin{frame}[fragile]{State Space Representation}
		...
		\begin{align}
			...
			+ \dimensions{\textbf{p}}{n}{m} \dimensions{\textbf{u}(t)}{m}{1} \nonumber\\
	...
	\begin{frame}[fragile]{Discrete State Space Representation}
		...
		Let $\dimensions{\boldsymbol{A_d}}{n}{n} = \exp{(\boldsymbol{A}T)}$ and $\dimensions{\boldsymbol{B_d}}{n}{m} = \{ \int_{0}^{T} \exp{(\boldsymbol{A}(T-s))}ds \} \boldsymbol{p}$.
	...
	\begin{frame}[fragile]{Transfer Function from Discrete State Space Representation}
		...
		Let $\dimensions{\boldsymbol{H_z}}{p}{m} = \dimensions{\boldsymbol{C}[z]}{p}{m} \dimensions{z\boldsymbol{[I-A_d]}}{n}{n}^{-1} \dimensions{\boldsymbol{B_d}}{p}{m}$.
