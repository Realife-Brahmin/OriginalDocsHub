...
\WorkEntry{Ongoing Doctoral Thesis}{Aug '22 - }{Multi-Period Optimal Power Flow in Distribution Systems\\ Supervisor : Dr. Anamika Dubey, Associate Professor, School of Electrical Engineering and Computer Sciences, Washington State University}{Currently devising an algorithm which facilitates for an optimal battery charging\/discharging schedule for minimizing an objective function for the grid, such as line losses or generation cost.}
