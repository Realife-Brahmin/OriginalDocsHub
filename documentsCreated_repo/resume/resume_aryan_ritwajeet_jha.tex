...
\large \usefont{OT1}{phv}{m}{n}\hfill \textit{Doctor of Philosophy in Electrical and Computer Engineering}
\par \normalsize \normalfont
...
\NewPart{Personal Details}
	\begin{table}[ht]
			\begin{tabular}{l l}
				...
				\textbf{E-mail} & \url{aryan.r.jha@gmail.com}, \url{aryan.jha@wsu.edu}
			\end{tabular}
	\end{table}
...
\EducationEntry{Doctor of Philosophy\\ Electrical and Computing Engineering \\ Washington State University \\ Pullman, WA}{2022 Aug -}{}{}
\sepspace
\EducationEntry{Master of Science \normalfont{\textit{(Thesis Defense Pending)}} \\ Electrical Engineering \\ Indian Institute of Technology Delhi}{2020-2022}{8.20/10.00 CGPA.}
\sepspace
\EducationEntry{Bachelor of Engineering. \\ Electrical and Electronics Engineering\\
with a Minor in Data Science \\
Birla Institute of Technology and Science Pilani\\ Hyderabad Campus}{2016-2020}{Secured 8.47/10.00 CGPA}
\sepspace
\EducationEntry{12th\\ Bansal Public School\\ Kota, Rajasthan}{2016}{Central Board of Secondary Education \\Secured 90.00\% marks}
\sepspace
\EducationEntry{10th\\
 St. Theresa's Convent Sr. Sec. School\\ Karnal, Haryana}{2014}{Central Board of
...
\sepspace
\WorkEntry{Courses in Data Science}{}{}{Applied Statistical Methods \\ Machine Learning \\ Information Retrieval\\ Fundamentals of Data Science \\ Optimization \\ Neural Networks and Fuzzy Logic}
\sepspace
\WorkEntry{Other Courses in Electrical Engineering}{}{}{Power Electronics \\ Electrical Machines \\ Electromagnetic Theory \\ Control Systems \\ Signals and Systems \\ Digital Signal Processing \\ Digital Electronics \\ Microprocessors and Interfacing \\ Analog Electronics\\ Digital Image Processing}
\sepspace
